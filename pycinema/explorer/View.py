...
class View(QtWidgets.QFrame):
    ...
    def __init__(self, content_layout='V'):
        ...
        # self.content.setStyleSheet("margin:0px;padding:0px;")
        match content_layout:
            case 'V': self.content.setLayout(QtWidgets.QVBoxLayout())
            case 'H': self.content.setLayout(QtWidgets.QHBoxLayout())
            case 'G': self.content.setLayout(QtWidgets.QGridLayout())
