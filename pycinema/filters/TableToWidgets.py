...
class DataModel(QtCore.QObject):
    s_update = QtCore.Signal(str, name='s_update')
    ...
    def set(self,data):
        ...
        self.s_update.emit(data)

class ParameterContainer(QtWidgets.QWidget):
...
class TableToWidgets(Filter):
    ...
    def _update(self):
        ...
        if self.model.requires_update:
          # only parse model
          self.model.requires_update = False
        else:
          # reset everything
          state = {}
