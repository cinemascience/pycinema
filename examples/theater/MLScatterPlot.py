...
vf5.setSizes([1016, 1016])
vf3.setSizes([502, 437])
vf2.setSizes([2039])
vf1.setSizes([946])
vf0.setSizes([2039])
...
PlotScatterItem_0.inputs.symbol.set("x", False)
PlotScatterItem_0.inputs.size.set(2.0, False)
