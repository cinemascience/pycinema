...
PlotLineView_0.inputs.title.set("Plot showing smooth line", False)
PlotLineView_0.inputs.background.set("white", False)
PlotLineView_0.inputs.plotitem.set(PlotLineItem_0.outputs.plotitem, False)
PlotLineView_1.inputs.title.set("Plot Showing Empty and NaN values", False)
...
PlotLineItem_1.inputs.penwidth.set(2.0, False)
