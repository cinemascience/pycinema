...
CinemaDatabaseWriter_0.inputs.path.set("ImageEdgeDetection.cdb", False)
CinemaDatabaseWriter_0.inputs.ignore.set(['^id', '^camera', '^FILE', '^FILE', '^FILE', '^FILE', '^FILE'], False)
