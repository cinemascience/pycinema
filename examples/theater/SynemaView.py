...
SynemaModelReader_0.inputs.path.set("/home/ollie/PycharmProjects/pycinema/data/dragon_synema_checkpoint", False)
...
RenderView_0.inputs.camera.set([-200.1, 73.9], False)
...
splitFrame2.setSizes([829, 829])
splitFrame1.insertView( 1, splitFrame2 )
splitFrame1.setSizes([1599, 1599])
