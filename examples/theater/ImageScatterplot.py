...
Python_0.inputs.inputs.set(CinemaDatabaseReader_0.outputs.table, False)
...
view7 = pycinema.theater.views.FilterView( ImageView_1 )
splitFrame2.insertView( 0, view7 )
view9 = pycinema.theater.views.FilterView( ImageView_0 )
splitFrame2.insertView( 1, view9 )
