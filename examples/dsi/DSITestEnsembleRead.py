...
DSICinemaDatabaseReader_1 = pycinema.filters.DSICinemaDatabaseReader()
DSICinemaDatabaseReader_2 = pycinema.filters.DSICinemaDatabaseReader()
...
# properties
DSICinemaDatabaseReader_0.inputs.path.set("DSIscratch/sphere00.cdb", False)
DSICinemaDatabaseReader_0.inputs.file_column.set("FILE", False)
DSICinemaDatabaseReader_1.inputs.path.set("DSIscratch/sphere01.cdb", False)
DSICinemaDatabaseReader_1.inputs.file_column.set("FILE", False)
DSICinemaDatabaseReader_2.inputs.path.set("DSIscratch/sphere02.cdb", False)
DSICinemaDatabaseReader_2.inputs.file_column.set("FILE", False)
ImageReader_0.inputs.table.set(DSICinemaDatabaseReader_2.outputs.table, False)
ImageReader_0.inputs.file_column.set("FILE", False)
ImageReader_0.inputs.cache.set(True, False)
ImageReader_1.inputs.table.set(DSICinemaDatabaseReader_1.outputs.table, False)
ImageReader_1.inputs.file_column.set("FILE", False)
ImageReader_1.inputs.cache.set(True, False)
ImageReader_2.inputs.table.set(DSICinemaDatabaseReader_0.outputs.table, False)
...
InspectorView_0.inputs.object.set(DSICinemaDatabaseReader_2.outputs.table, False)
InspectorView_1.inputs.object.set(DSICinemaDatabaseReader_1.outputs.table, False)
InspectorView_2.inputs.object.set(DSICinemaDatabaseReader_0.outputs.table, False)
